...
const PlaceRegistration = () => {
  ...
  const [checOutTime, setCheckOutTime] = useState('');
  ...
  const handleAddImageLinkButton = (e) => {
    ...
    axios.post(`${baseURL}/users/upload-by-link`, {
      imageLink: imageURL
  ...
  return (
    ...
    <form>
      <h1 className="text-2xl text-center font-medium text-gray-600" onSubmit={(e)=>e.preventDefault()}>Register your Place</h1>
      <div>
      ...
      <div>
        ...
        <div className="flex gap-2">
          <input
            ...
            className="border-2 border-gray-600 cursor-pointer p-2 rounded-2xl w-full mt-2"
          ></input>
          <button className="bg-gray-300 rounded-2xl cursor-pointer whitespace-nowrap px-4" onClick={handleAddImageLinkButton}>
            Add Image
          </button>
        </div>
        <div className="mt-3 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
          <button className="border-2 flex justify-center text-gray-600 gap-2 rounded-2xl border-gray-500 p-10 content-center">
            <svg
      ...
      <div>
        <h1 className="text-2xl font-semibold text-gray-700 mt-4">Discription</h1>
        <textarea
      ...
      <div>
        ...
        <div className="mt-6 bg-[#E82561] py-2 rounded-2xl text-center text-xl shadow-2xl font-medium text-white">
            Save
        </div>
        </form>
      </div>
