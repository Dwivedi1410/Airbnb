const PerksSelection = ({ perk }) => {
  ...
  if (perk === "Finger Print Lock System") {
    return (
      <div className="flex gap-2">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <h2>Finger Print Lock System</h2>
      </div>
    );
  }
